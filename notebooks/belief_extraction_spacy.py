...
# Check for compatibility (spacy: 3.5.4, coreferee==1.4.0, coreferee-model-en==1.0.0)
from negspacy.negation import Negex
from negspacy.termsets import termset
import coreferee

# Check for compatibilty, run the file individually
from my_negex import MyNegex

# Extensions must be set before they are used in SpaCy v3
...
#     # Load SpaCy model and add custom components to the pipeline
#     nlp = spacy.load('en_core_web_lg')
#     add_to_pipe(nlp)

#     # Example 
#     text = "I believe the weather will be sunny tomorrow, but I doubt it will stay that way."

#     # Processing the text with the pipeline
#     doc = nlp(text)

#     # Extract beliefs from the processed doc
#     beliefs = [b for sent in doc.sents for b in sent._.beliefs]
